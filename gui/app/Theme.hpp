...
public:
    ...
    */
    ...
    static constexpr double POST_NOTE_EDGE_THRESHOLD = 8.0 ;
    static constexpr double POST_NOTE_MIN_WIDTH      = 100.0 ;
    static constexpr double POST_NOTE_DEFAULT_WIDTH  = 260.0 ;
